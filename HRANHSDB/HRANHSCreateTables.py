...
from HRAModels import User,MedicineAsset,Vendor,VendorMedicineAsset
class HRANHSCreateTables:
    ...
    def create(hracrud :HRANHSCRUD):
        ...
        hracrud.create_table(VendorMedicineAsset.fields_to_tuple(),VendorMedicineAsset.VENDORMEDICINEASSETDATATYPES,VendorMedicineAsset.VENDORMEDICINEASSETSTABLENAME)        
